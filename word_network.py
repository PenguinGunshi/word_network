...
#中心性解析
#次数中心性
#d_values = degree_centrality(G).values()
#d_central = degree_centrality(G)
#d_keys = degree_centrality(G).keys()
...
#媒介中心性
#d_values = betweenness_centrality(G).values()
#d_central = betweenness_centrality(G)
#d_keys = betweenness_centrality(G).keys()
...
for v in range(len(d_values_list)):
    #次数中心性
    node_size[v] = d_values_list[v] * d_values_list[v] * 3000
#近接中心性
